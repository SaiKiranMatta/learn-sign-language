...
export default function BodypartsHomeScreen() {
    ...
    const handleNextPressIn = () => {
        if (levelsFinishedToday < 100 && userData) {
            ...
            switch (animalLevel) {
                case 1:
                    router.replace("/bodyparts/level1");
                    break;
                case 2:
                    router.replace("/bodyparts/level2");
                    break;
                case 3:
                    router.replace("/bodyparts/level3");
                    break;
                case 4:
                    router.replace("/bodyparts/level4");
                    break;
                case 5:
                ...
                case 7:
                    ...
                    break;
                case 8:
                    router.replace("/bodyparts/level8");
                    break;
                case 9:
                    router.replace("/bodyparts/level9");
                    break;
                case 10:
                    router.replace("/bodyparts/level10");
                    break;
                case 11:
                    router.replace("/bodyparts/level11");
                    break;
                case 12:
                    router.replace("/bodyparts/level12");
                default:
                    router.replace("/bodyparts/level1");
                    break;
            }
