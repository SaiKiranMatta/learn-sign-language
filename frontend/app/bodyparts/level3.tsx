...
export default function BodypartFindScreen() {
    ...
    const [cloudText, setCloudText] = useState<string>("Find Nose!");
    ...
    const handleObjectPress = () => {
        ...
        setCloudText("Good Job, Bodypart Found!");
    };
    useEffect(() => {
    ...
    return (
        <SafeAreaView className=" bg-[#FDD58D] pt-6 h-full ">
            ...
            <View className="absolute z-50 flex flex-row items-center bg-transparent top-10 left-4">
                <TouchableOpacity
                    onPress={() => router.replace("/bodyparts/level2")}
                    className=""
                >
            ...
            <View className="absolute flex pl-48 items-center bg-[#FDD58D] justify-end w-full h-full">
                ...
                >
                    ...
                    <Pressable
                        ...
                        className={`absolute w-12 h-20 bg-transparent ${border}  left-44 top-28`}
                    ></Pressable>
                </View>
            </View>
        </SafeAreaView>
