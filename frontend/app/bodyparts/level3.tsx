...
export default function EveryDayObjectFindScreen() {
    ...
    const [cloudText, setCloudText] = useState<string>("Find the Bucket!");
    ...
    const handleObjectPress = () => {
        ...
        setCloudText("Good Job, EveryDayObject Found!");
    };
    useEffect(() => {
    ...
    return (
        <SafeAreaView className=" bg-[#FDD58D] pt-6 h-full ">
            ...
            <View className="absolute z-50 flex flex-row items-center bg-transparent top-10 left-4">
                <TouchableOpacity
                    onPress={() => router.replace("/everyDayObjects/level2")}
                    className=""
                >
            ...
            <View className="absolute flex pl-48 items-center bg-[#FDD58D] justify-end w-full h-full">
                ...
                >
                    ...
                    <Pressable
                        ...
                        className={`absolute w-32 h-36 bg-transparent ${border}  left-5 top-2`}
                    ></Pressable>
                </View>
            </View>
        </SafeAreaView>
