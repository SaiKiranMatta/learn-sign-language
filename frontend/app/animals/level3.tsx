...
export default function AnimalFindScreen() {
    ...
    const [cloudText, setCloudText] = useState<string>("Find the Animal!");
    ...
    return (
        <SafeAreaView className=" bg-[#FDD58D] pt-6 h-full ">
            ...
            <View className="absolute z-50 flex flex-row items-center bg-transparent top-10 left-4">
                <TouchableOpacity
                    onPress={() => router.replace("/animals/level2")}
                    className=""
                >
            ...
            <View className="absolute flex pl-48 items-center bg-[#FDD58D] justify-end w-full h-full">
                ...
                >
                    <Image
                        source={require("@/assets/images/animals/find_one_animal.jpg")}
                        className="h-56 rounded-lg w-96"
                    />
                    <Pressable
                        onPress={handleObjectPress}
                        className={`absolute w-20 h-16 bg-transparent ${border}  left-48 top-32`}
                    ></Pressable>
                </View>
            </View>
        </SafeAreaView>
