...
export default function AnimalDetectcreen() {
    const curLevel = 12;
    ...
    const handleNextPressIn = async () => {
        ...
        if (levelsFinishedToday < 10 && user) {
            if (userData.animals.cLArray[curLevel - 1] === 0 && isComplete) {
                ...
                const sC = userData.animals.sC + 1;
                const newUserData = {
                    ...userData,
                    animals: {
                        ...userData.animals,
    ...
    return (
        <SafeAreaView className=" bg-[#FDD58D] pt-6 h-full ">
            ...
            <View className="absolute z-50 flex flex-row items-center bg-transparent top-10 left-4">
                <TouchableOpacity
                    onPress={() => router.replace("/animals/level11")}
                    className=""
                >
            ...
            <View className="absolute flex flex-row pl-64 items-center mt-10 bg-[#FDD58D] justify-start w-full h-full">
                ...
                >
                    <Image
                        source={require("@/assets/images/animals/lion.jpeg")}
