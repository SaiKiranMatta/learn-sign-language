...
export default function EveryDayObjectsHomeScreen() {
    ...
    const handleNextPressIn = () => {
        ...
        if (
            ...
            switch (animalLevel) {
                case 1:
                    router.replace("/everyDayObjects/level1");
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    router.replace("/everyDayObjects/level4");
                    break;
                case 5:
                ...
                case 7:
                    ...
                    break;
                case 8:
                    router.replace("/everyDayObjects/level8");
                    break;
                case 9:
                    router.replace("/everyDayObjects/level9");
                    break;
                case 10:
                    router.replace("/everyDayObjects/level10");
                    break;
                case 11:
                    router.replace("/everyDayObjects/level11");
                    break;
                case 12:
                    router.replace("/everyDayObjects/level12");
                default:
                    router.replace("/everyDayObjects/level1");
                    break;
            }
    ...
    return (
        <SafeAreaView className=" bg-[#FDD58D] pt-6 h-full ">
            ...
            {cloudText !== "" && (
                ...
                >
                    <Text className="pt-10 pb-12 text-xl text-center px-7">
                        {cloudText}
                    </Text>
                </ImageBackground>
            )}
            ...
            <View className="absolute flex items-center bg-[#FDD58D] justify-center w-full h-full">
                ...
                >
                    <Image
                        source={require("@/assets/images/everyDayObjects/Every-Day-Objects-main.jpg")}
